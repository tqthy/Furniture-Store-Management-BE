...
const invoiceRoute = (app) => {
    router.post('/create-invoice',JwtService.checkUserJwt, JwtService.checkUserPermission, InvoiceController.createInvoice);
    router.put('/accept-invoice/:id', JwtService.checkUserJwt, JwtService.checkUserPermission, InvoiceController.acceptInvoice);
